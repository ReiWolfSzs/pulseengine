...
class Strumline extends FlxTypedGroup<FlxBasic> {
	...
	public function new(x:Float = 0, playState:PlayState, ?character:Character, ?displayJudgements:Bool = true, ?autoplay:Bool = true, ?keyAmount:Int = 4, ?downscroll:Bool = false, ?parent:Strumline) {
		super();
